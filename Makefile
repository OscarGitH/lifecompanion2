...
publish:
	...
	@$(MAKE) lc-cargo target="editor" c="set-version --manifest-path Cargo.toml $npm_package_version"
	@$(MAKE) lc-cargo target="player" c="set-version --manifest-path Cargo.toml $npm_package_version"
#	@git add -A
